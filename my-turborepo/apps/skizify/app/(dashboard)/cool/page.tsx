            ...
            <div>
              <form>
                <div className="ms-auto lg:mx-auto lg:me-0 lg:max-w-xl">
                  <Card className="border p-2 sm:p-3 md:p-6 lg:p-7 shadow-lg backdrop-blur-xl dark:border-neutral-700 dark:bg-black">
                    <CardHeader className="text-center">
                      <h2 className= " text-2xl md:text-3xl font-semibold leading-none tracking-tight dark:text-neutral-200">
                    ...
                    <CardContent>
                      <Button className="h-10 sm:h-12 w-full border bg-white px-3  text-sm  sm:text-base text-neutral-700 hover:bg-neutral-50 dark:border-neutral-800 dark:bg-black dark:text-neutral-300 dark:hover:bg-white/5">
                        <svg
                      ...
                      <div className="relative">
                          <Button className="h-10 sm:h-12 w-full border bg-white px-3  text-sm  sm:text-base text-neutral-700 hover:bg-neutral-50 dark:border-neutral-800 dark:bg-black dark:text-neutral-300 dark:hover:bg-white/5 mt-4">
                            <svg
                      ...
                      <div className="mt-5">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <Input
                            ...
                            type="password"
                          />
                          <div className="col-span-2 mt-3 flex items-center cursor-pointer space-x-2">
                            <Checkbox
                              id="terms"
