  ...
  return (
    <div className="flex h-[85%] w-full rounded-xl from-neutral-900 via-black to-neutral-900 dark:bg-gradient-to-r sm:h-[92%]">
      ...
      className={`
        ...
        ${isChatBarVisible
          ? 'fixed inset-y-0 right-0 z-50 w-[80%] md:max-w-50% opacity-100 lg:static lg:w-3/12'
          : 'fixed -right-full w-0 opacity-0 lg:w-0 lg:opacity-100'
        }
      `}
    >
      <div className="flex h-full rounded-lg flex-col overflow-hidden border bg-mediumdark dark:border-1 dark:border-neutral-800 dark:bg-white">
        ...
        <div className="no-scrollbar flex-1 overflow-y-auto p-2 pt-4">
          <div className="space-y-4">{/* Chat messages would go here */}</div>
        </div>
