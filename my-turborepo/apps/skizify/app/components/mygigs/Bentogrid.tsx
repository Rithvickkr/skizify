        ...
        <Card className="group relative w-full overflow-hidden bg-gradient-to-br from-neutral-50 via-neutral-100 to-neutral-100 p-3 shadow-lg transition-all duration-500 ease-in-out hover:shadow-2xl dark:from-black dark:to-v0dark/70">
          ...
          <CardHeader className="relative z-10 pb-0">
            <div className="absolute right-4 top-2">
              ...
              >
                <svg
                  ...
                  className="mr-1 text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-black"
                >
            ...
            <div className="flex flex-col items-center space-y-4 sm:flex-row sm:justify-between sm:space-y-0">
              <Avatar className="size-16 rounded-xl border-4 border-white dark:border-neutral-800 shadow-xl transition-all duration-500 ease-in-out group-hover:scale-105 group-hover:rotate-3">
