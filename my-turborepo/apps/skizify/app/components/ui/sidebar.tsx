...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex h-10 w-full flex-row items-center justify-between bg-neutral-100 px-4 py-4 dark:bg-black  md:hidden",
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="!m-0 inline-block whitespace-pre !p-0 text-base font-helvetica text-neutral-700 transition duration-150 group-hover/sidebar:translate-x-1 dark:text-neutral-200"
      >
        {link.label}
      </motion.span>
    </Link>
